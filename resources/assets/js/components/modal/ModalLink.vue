<template>
  <span>
    ...
    <span v-if="!item"><!--quando nao tiver item-->
      ...
      methods:{
        preencheFormulario:function () {
          axios.get(this.url + this.item.id).then(res => {
            console.log(res.data);//testar se ta trazendo e vendo o que ta trazendo =res.data
            this.$store.commit('setItem',res.data);
          });//requizicao tipo get - usando axios que ja vem com laravel
